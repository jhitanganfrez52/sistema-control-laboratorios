    ...
    <>
      ...
      <nav className="flex items-center justify-between px-12 py-3 bg-white shadow-sm">
        ...
        <div className="flex items-center gap-4">
          <img
            src={logo}
            className="w-24 object-contain hover:scale-105 transition"
          />
        ...
        <div className="flex items-center gap-10 text-blue-700 font-medium">
          <button className="hover:text-blue-900 transition">Inicio</button>
          <button className="hover:text-blue-900 transition">Funciones</button>
        ...
        <button
          ...
          className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-6 py-2.5 rounded-xl shadow hover:scale-105 transition"
        >
          Iniciar Sesión
        </button>
      </nav>
